...
if __name__ == '__main__':
    ...
    eval_dset = VQAFeatureDataset(
        'val', dictionary, dataroot=args.data_root, layer=args.layer, inference=args.inference)
    ...
    if args.eval:
        ...
        getattr(cnn, args.layer).register_forward_hook(
            get_activation(args.layer))
        ...
        train_dset = VQAFeatureDataset(
            'train', dictionary, dataroot=args.data_root, layer=args.layer)
